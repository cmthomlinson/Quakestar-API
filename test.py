...
def test(floor_id, doc_id): 
    ...
    w2 = doc['32']['x'] * doc['32']['y'] * info[floor_id]['25'][doc['25']]['strength'] + (doc['31']['x'] + doc['31']['y'])*2*((info[floor_id]['28'][doc['28']]['strength'] + info[floor_id]['17'][doc['17']]['strength'])/2)
    w3 = doc['32']['x'] * doc['32']['y'] * info[floor_id]['25'][doc['25']]['strength'] + (doc['31']['x'] + doc['31']['y'])*2*((info[floor_id]['28'][doc['28']]['strength'] + info[floor_id]['17'][doc['17']]['strength'])/2) + (doc['31']['x'] * doc['31']['y'])*info[floor_id]['18'][doc['18']]['strength']
    w4 = doc['32']['x'] * doc['32']['y'] * info[floor_id]['25'][doc['25']]['strength'] + (doc['31']['x'] + doc['31']['y'])*2*((info[floor_id]['28'][doc['28']]['strength'] + info[floor_id]['17'][doc['17']]['strength'])/2) + (doc['31']['x'] * doc['31']['y'])*info[floor_id]['18'][doc['18']]['strength'] + (doc['30']['x'] + doc['30']['y'])*2*((info[floor_id]['27'][doc['27']]['strength']+info[floor_id]['15'][doc['15']]['strength'])/2)
    w5 = doc['32']['x'] * doc['32']['y'] * info[floor_id]['25'][doc['25']]['strength'] + (doc['31']['x'] + doc['31']['y'])*2*((info[floor_id]['28'][doc['28']]['strength'] + info[floor_id]['17'][doc['17']]['strength'])/2) + (doc['31']['x'] * doc['31']['y'])*info[floor_id]['18'][doc['18']]['strength'] + (doc['30']['x'] + doc['30']['y'])*2*((info[floor_id]['27'][doc['27']]['strength']+info[floor_id]['15'][doc['15']]['strength'])/2) + (doc['30']['x']*doc['30']['y'])*info[floor_id]['16'][doc['16']]['strength']
    w6 = doc['32']['x'] * doc['32']['y'] * info[floor_id]['25'][doc['25']]['strength'] + (doc['31']['x'] + doc['31']['y'])*2*((info[floor_id]['28'][doc['28']]['strength'] + info[floor_id]['17'][doc['17']]['strength'])/2) + (doc['31']['x'] * doc['31']['y'])*info[floor_id]['18'][doc['18']]['strength'] + (doc['30']['x'] + doc['30']['y'])*2*((info[floor_id]['27'][doc['27']]['strength']+info[floor_id]['15'][doc['15']]['strength'])/2) + (doc['30']['x']*doc['30']['y'])*info[floor_id]['16'][doc['16']]['strength'] + (doc['29']['x'] + doc['29']['y'])*2*((info[floor_id]['26'][doc['26']]['strength'] + info[floor_id]['13'][doc['13']]['strength'])/2)
    w7 = doc['32']['x'] * doc['32']['y'] * info[floor_id]['25'][doc['25']]['strength'] + (doc['31']['x'] + doc['31']['y'])*2*((info[floor_id]['28'][doc['28']]['strength'] + info[floor_id]['17'][doc['17']]['strength'])/2) + (doc['31']['x'] * doc['31']['y'])*info[floor_id]['18'][doc['18']]['strength'] + (doc['30']['x'] + doc['30']['y'])*2*((info[floor_id]['27'][doc['27']]['strength']+info[floor_id]['15'][doc['15']]['strength'])/2) + (doc['30']['x']*doc['30']['y'])*info[floor_id]['16'][doc['16']]['strength'] + (doc['29']['x'] + doc['29']['y'])*2*((info[floor_id]['26'][doc['26']]['strength'] + info[floor_id]['13'][doc['13']]['strength'])/2) + (doc['29']['x'] * doc['29']['y'])*info[floor_id]['14'][doc['14']]['strength']
...
test("3", "613caf002e2ce3464d1ce745")
