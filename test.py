...
def test(floor_id, doc_id): 
    ...
    w2 = (doc['26']['x'] * doc['26']['y'] * info[floor_id]['21'][doc['21']]['strength']) + (doc['24']['x'] + doc['24']['y'])*2*((info[floor_id]['22'][doc['22']]['strength'] + info[floor_id]['13'][doc['13']]['strength'])/2)
    w3 = (doc['26']['x'] * doc['26']['y'] * info[floor_id]['21'][doc['21']]['strength']) + (doc['24']['x'] + doc['24']['y'])*2*((info[floor_id]['22'][doc['22']]['strength'] + info[floor_id]['13'][doc['13']]['strength'])/2) + (doc['24']['x'] * doc['24']['y'])*info[floor_id]['14'][doc['14']]['strength'] 
    w4 = (doc['26']['x'] * doc['26']['y'] * info[floor_id]['21'][doc['21']]['strength']) + (doc['24']['x'] + doc['24']['y'])*2*((info[floor_id]['22'][doc['22']]['strength'] + info[floor_id]['13'][doc['13']]['strength'])/2) + (doc['24']['x'] * doc['24']['y'])*info[floor_id]['14'][doc['14']]['strength'] + (doc['25']['x'] + doc['25']['y'])*2*((info[floor_id]['23'][doc['23']]['strength'] + info[floor_id]['15'][doc['15']]['strength'])/2)
...
test("1b", "613cc5b98b37fdf640d31d5d")
