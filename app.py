...
def sd(floor_id, doc_id):
    ...
    t = 3**((strength/50)**1.5)
    z = irregulaties(floor_id, doc)* max(info[floor_id]['10'][doc['10']]['strength'], info[floor_id]['11'][doc['11']]['strength'], info[floor_id]['12'][doc['12']]['strength'])
    k = 9*((damage_all(floor_id, doc)*z)**0.25)
