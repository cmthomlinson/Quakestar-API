...
def irregulaties(floor_id, doc):
    ...
    if floor_id == "1":
        ...
        return 1*info[floor_id]['22'][doc['22']]['strength']
    ...
    if floor_id == "2":
        ...
        return min(x0, x1, x2)*info[floor_id]['29'][doc['29']]['strength']
    ...
    if floor_id == "3":
        ...
        return min(x0, x1, x2, x3, x4)*info[floor_id]['36'][doc['36']]['strength']
