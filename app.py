...
def floor_area_wall_bracing(floor_id, doc_id):
    ...
    if floor_id == "2":
        ...
        x3 = (50/3)/((doc['26']['x'] * doc['26']['y'] * info[floor_id]['21'][doc['21']]['strength'] + ((doc['25']['x'] + doc['25']['y'])*2)*info[floor_id]['23'][doc['23']]['strength'] + doc['25']['y']*doc['25']['y']*info[floor_id]['17'][doc['17']]['strength'] + ((doc['24']['x'] + doc['24']['y'])*2)*info[floor_id]['13'][doc['13']]['strength'])/((doc['27']['x']*info[floor_id]['17'][doc['17']]['strength'])))
        x4 = (50/3)/((doc['26']['x'] * doc['26']['y'] * info[floor_id]['21'][doc['21']]['strength'] + ((doc['25']['x'] + doc['25']['y'])*2)*info[floor_id]['23'][doc['23']]['strength'] + doc['25']['y']*doc['25']['y']*info[floor_id]['17'][doc['17']]['strength'] + ((doc['24']['x'] + doc['24']['y'])*2)*info[floor_id]['13'][doc['13']]['strength'])/((doc['27']['y']*info[floor_id]['18'][doc['18']]['strength'])))
    ...
    if floor_id == "3b":
        ...
        x8 = (50/3)/((doc['38']['x'] * doc['38']['y'] * info[floor_id]['29'][doc['29']]['strength'] + ((doc['36']['x'] + doc['36']['y'])*2)*((info[floor_id]['32'][doc['31']]['strength'] + info[floor_id]['17'][doc['17']]['strength'])/2) + (doc['36']['x'] * doc['36']['y'])*info[floor_id]['18'][doc['18']]['strength'] + ((doc['36']['x'] + doc['36']['y'])*2)*((info[floor_id]['31'][doc['31']]['strength'] + info[floor_id]['15'][doc['15']]['strength'])/2) + (doc['36']['x'] * doc['36']['y'])*info[floor_id]['16'][doc['16']]['strength'] + (((doc['34']['x'] + doc['34']['y'])*2)*(info[floor_id]['30'][doc['30']]['strength'] + info[floor_id]['13'][doc['13']]['strength'])/2) + (doc['34']['x'] * doc['34']['y'])*info[floor_id]['14'][doc['14']]['strength'] + ((doc['37']['x'] + doc['37']['y'])*2)*((info[floor_id]['33'][doc['33']]['strength'] + info[floor_id]['19'][doc['19']]['strength'])/2))/(info[floor_id]['28'][doc['28']]['strength'] * doc['42']['y']))
